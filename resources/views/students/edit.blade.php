                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 form-check">
                                    ...
                                    <input type="checkbox" name="course_ids[]" value="{{ $course->id }}" class="col-sm-8 form-check-input" {{ in_array($course->id,$student->courses->pluck('id')->toArray()) ? 'checked' : '' }}> {{ $course->title }} <i class="input-helper"></i></label>
                                </div>
                            </div>
                            @endforeach
                        </div>
