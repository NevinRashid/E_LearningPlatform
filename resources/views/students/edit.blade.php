...
@section('content')
<div class="row">
    <form action="{{ route('students.update',$student) }}" method="POST"  enctype="multipart/form-data" class="form-sample">
        @csrf
        @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select name="role" class="form-select" aria-haspopup="true" aria-expanded="false">
                                ...
                                <option value="trainer" >tariner</option>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 form-check">
                                    ...
                                    <input type="checkbox" name="courses_ids[]" value="{{ $course->id }}" class="col-sm-8 form-check-input" {{ in_array($course->id,$student->courses->pluck('id')->toArray()) ? 'checked' : '' }}> {{ $course->title }} <i class="input-helper"></i></label>
                                </div>
                            </div>
                            @endforeach
                        </div>
        ...
        <a href="{{ route('students.index') }}" class="btn btn-secondary btn-lg mb-4 ">Cancel</a>
    </form>
</div>
@endsection
